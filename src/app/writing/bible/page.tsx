      ...
      try {
        ...
        if (projectId) {
          ...
          if (cloudProject) {
            ...
            setBibleContent(transformed.content as BibleContent)
          }
        } else {
              ...
              {selectedType === 'character' && (
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      value={selectedItem.shortSummary}
                  ...
                  <div>
                    ...
                    <textarea
                      value={selectedItem.coreMotivation}
                  ...
                  <div>
                    ...
                    <textarea
                      value={selectedItem.internalConflict}
                  ...
                  <div>
                    ...
                    <textarea
                      value={selectedItem.externalConflict}
                  ...
                  <div>
                    ...
                    <textarea
                      value={selectedItem.seasonOneArc}
                  ...
                  <div>
                    ...
                    <textarea
                      value={selectedItem.longTermArc}
              ...
              {selectedType === 'location' && (
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      value={selectedItem.visualDetails}
              ...
              {selectedType === 'timeline' && (
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      value={selectedItem.charactersInvolved?.join(', ') || ''}
              ...
              {selectedType === 'theme' && (
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      value={selectedItem.manifestations}
                  ...
                  <div>
                    ...
                    <textarea
                      value={selectedItem.characterConnections}
